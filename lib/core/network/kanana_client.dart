...
///
/// 사용자가 직접 입력하거나 dart-define으로 주입된 본인의 키로 직접 호출한다.
/// 브라우저는 Kanana-o가 CORS preflight에 응답하지 않아 차단되므로 네이티브 전용.
class KananaClient {
  /// Kanana-o 공식 엔드포인트. 뒤에 `/chat/completions`가 붙는다.
  final String baseUrl;

  /// Authorization Bearer 토큰으로 보낼 키.
  final String apiKey;
